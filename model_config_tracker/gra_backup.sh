...
mysql -u root -p"mysql" -e "use gra; select * from analytical_models where enabled=1\G;" > "C:/Users/jgunn/gurucul/model_config_tracker/config_history/gra_models_$current_date.txt"
